...
# create nevilles method function
...
# create divided difference function
...
# create approximate result function
def approximate_result(matrix, x_points, value): 
    reoccuring_x_span = 1
...
if __name__ == "__main__":   
    ...
    approximating_x = 7.3
    final_approximation = approximate_result(divided_table, x_points, approximating_x)    
    AnswerArray = []
